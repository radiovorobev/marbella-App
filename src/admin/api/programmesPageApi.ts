...
export const programmesPageApi = {
  ...
  async getProgrammesPageData(): Promise<ProgrammesPageData | null> {
    try {
      ...
      if (error) {
        ...
        console.error('Supabase error when getting programmes page data:', error);
        throw error;
      }
  ...
  async updateProgrammesPageData(formData: ProgrammesPageFormData): Promise<ProgrammesPageData> {
    try {
